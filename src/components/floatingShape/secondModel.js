...
import image from '../../images/third.glb'

export default function ModelSecond({mouse}) {
  ...
  return (
    <group>
      ...
      <Mesh node={nodes.Sphere003} multiplier={1.2} mouse={mouse} isActive={activeShape == 3}/>
      <Mesh node={nodes.Sphere} multiplier={1} mouse={mouse} isActive={activeShape == 4}/>
      <Mesh node={nodes.Torus002} multiplier={1.8} mouse={mouse} isActive={activeShape == 5}/>
    </group>
  );
}
