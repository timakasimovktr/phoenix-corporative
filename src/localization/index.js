      ...
      translation: {
        ...
        blocks: {
            ...
            productsBlock :{
                ...
                description8: 'Способствует снижению веса. Содержащейся в комплексе компоненты способствуют в ускорении обмена веществ.',
            },
            bioAdds: {
                subtitle: 'Не уверены, с чего начать? Пройдите онлайн-опрос, чтобы подобрать идеальный набор',
        ...
        translation: {
            ...
            blocks: {
                ...
                productsBlock :{
                    ...
                    description8: 'Килограмм ҳалок бўлишига ёрдам беради. Комплекс таркибидаги компонентлар метаболизмнинг тезлашишига ёрдам беради.',
                },
                bioAdds: {
                    subtitle: 'Қаердан бошлашни билмаяпсизми? Мукаммал тўпламни топиш учун онлайн сўров ўтказинг',
